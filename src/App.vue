  ...
  <div id="app" class="container">
    ...
    <b-card>
      ...
      <b-form-group label="CPF:">
        <b-form-input type="number" size="lg" v-model="usuario.cpf" placeholder="Inform CPF"></b-form-input>
      </b-form-group>
...
export default {
  ...
  methods: {
    ...
    excluir(id) {
      this.$http.delete('/api/cadastro/destroy')
          .then(() => this.limpar())
          .catch(() => {
            this.mensagens.push({
              texto: 'Falha ao excluir. Entre em contato com o Admnistrador',
              tipo: 'danger'
            })
          })
    ...
    salvar() {
      this.$http.post('/api/cadastro/store')
          .then(() => {
            this.limpar()
            this.mensagens.push({
    ...
    obterUsuario() {
      this.$http.get('/api/cadastro/show')
          .then(res => {
